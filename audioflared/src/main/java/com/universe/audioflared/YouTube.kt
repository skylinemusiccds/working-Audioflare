package com.universe.audioflared

import com.universe.audioflared.models.AccountInfo
import com.universe.audioflared.models.AlbumItem
import com.universe.audioflared.models.Artist
import com.universe.audioflared.models.ArtistItem
import com.universe.audioflared.models.BrowseEndpoint
import com.universe.audioflared.models.GridRenderer
import com.universe.audioflared.models.MusicCarouselShelfRenderer
import com.universe.audioflared.models.PlaylistItem
import com.universe.audioflared.models.SearchSuggestions
import com.universe.audioflared.models.SongItem
import com.universe.audioflared.models.WatchEndpoint
import com.universe.audioflared.models.WatchEndpoint.WatchEndpointMusicSupportedConfigs.WatchEndpointMusicConfig.Companion.MUSIC_VIDEO_TYPE_ATV
import com.universe.audioflared.models.YouTubeClient.Companion.ANDROID_MUSIC
import com.universe.audioflared.models.YouTubeClient.Companion.TVHTML5
import com.universe.audioflared.models.YouTubeClient.Companion.WEB
import com.universe.audioflared.models.YouTubeClient.Companion.WEB_REMIX
import com.universe.audioflared.models.YouTubeLocale
import com.universe.audioflared.models.getContinuation
import com.universe.audioflared.models.oddElements
import com.universe.audioflared.models.response.AccountMenuResponse
import com.universe.audioflared.models.response.BrowseResponse
import com.universe.audioflared.models.response.GetQueueResponse
import com.universe.audioflared.models.response.GetSearchSuggestionsResponse
import com.universe.audioflared.models.response.GetTranscriptResponse
import com.universe.audioflared.models.response.NextResponse
import com.universe.audioflared.models.response.PipedResponse
import com.universe.audioflared.models.response.PlayerResponse
import com.universe.audioflared.models.response.SearchResponse
import com.universe.audioflared.models.splitBySeparator
import com.universe.audioflared.pages.AlbumPage
import com.universe.audioflared.pages.ArtistItemsContinuationPage
import com.universe.audioflared.pages.ArtistItemsPage
import com.universe.audioflared.pages.ArtistPage
import com.universe.audioflared.pages.BrowseResult
import com.universe.audioflared.pages.ExplorePage
import com.universe.audioflared.pages.MoodAndGenres
import com.universe.audioflared.pages.NewReleaseAlbumPage
import com.universe.audioflared.pages.NextPage
import com.universe.audioflared.pages.NextResult
import com.universe.audioflared.pages.PlaylistContinuationPage
import com.universe.audioflared.pages.PlaylistPage
import com.universe.audioflared.pages.RelatedPage
import com.universe.audioflared.pages.SearchPage
import com.universe.audioflared.pages.SearchResult
import com.universe.audioflared.pages.SearchSuggestionPage
import com.universe.audioflared.pages.SearchSummary
import com.universe.audioflared.pages.SearchSummaryPage
